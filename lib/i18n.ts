...
const et = {
  ...
  home: {
    ...
    // Avaleht (Broadcast Grid)
    round: 'R',
    nextRound: 'Järgmine võistlus',
    roundStripAria: 'Järgmine võistlus ja loendur',
    countdownDays: 'P',
    countdownHours: 'T',
    countdownMinutes: 'M',
    countdownSeconds: 'S',
    countdownDaysLong: 'päeva',
    countdownHoursLong: 'tundi',
    countdownMinutesLong: 'min',
    countdownSecondsLong: 'sek',
    countdownAria: 'Aeg järgmise võistluse alguseni',
    ongoing: 'Käimas',
    quickLinksAria: 'Kiirlingid',
    quickLive: 'Otse',
    quickCalendar: 'Kalender',
    quickResults: 'Tulemused',
    quickClasses: 'Klassid',
    quickNewFans: 'Uus rallis?',
    newsUnavailable: 'Uudiseid ei õnnestunud praegu laadida. Värsked ralliuudised on autosport.ee lehel.',
    newsHeroAria: 'Päevakajalised uudised',
    newsSlideOf: (n: number, total: number) => `Uudis ${n} / ${total}`,
    newsPause: 'Peata vahetumine',
    newsPlay: 'Jätka vahetumist',
    seasonTitle: 'Hooaeg 2026',
    seasonAria: 'Hooaja kalender',
    seasonAll: 'Kogu kalender',
    seasonDone: 'Toimunud',
    seasonNext: 'Järgmine',
    standingsTitle: 'Punktiseis',
    standingsClass: 'EMV absoluutarvestus',
    standingsSample: 'Näidisandmed',
    standingsSampleNote: 'Päris punktiseis lisandub pärast EAL-i andmeallika liidestamist.',
    standingsFull: 'Kogu punktiseis',
    standingsSource: 'Allikas: EAL',
    standingsUpdated: 'uuendatud',
    standingsPending: 'lisandub',
    standingsPoints: 'p',
    newsTitleGrid: 'Uudised',
    joinTitle: 'Tule rallile',
    joinLead: 'Kiiruskatsed on tasuta vaadatavad. Vaata, kuidas pealtvaatajana turvaliselt raja äärde saada.',
    joinCta: 'Pealtvaatajale',
    joinCompete: 'Võistlejale',
  },
  calendar: {
    eyebrow: 'Kalender',
  ...
  results: {
    ...
    poweredByAria: 'RallyLynx — ajavõtu ja tulemuste platvorm (avaneb uues aknas)',
    position: 'Koht',
  ...
  live: {
    ...
    classLabel: 'Klass',
    chooseClass: 'Vali klass',
    classView: (name: string) => `${name} arvestus`,
    classPositionsNote: 'Koht ja vahe on arvutatud valitud klassi sees RallyLynxi üldarvestuse aegadest.',
    stage: 'Kiiruskatse',
    chooseStage: 'Vali kiiruskatse',
    latest: 'Viimane',
    after: (stage: string) => `pärast ${stage}`,
    overallAfter: (stage: string) => `Üldarvestus — pärast ${stage}`,
    eventBarAria: 'Võistlus ja staatus',
    finished: 'Lõppenud',
    scheduled: 'Ei ole alanud',
    crewCount: (n: number) => `${n} ekipaaži`,
    connectionLost: 'Ühendus katkes.',
    showingStateFrom: 'Näitan seisu kell',
    retry: 'Proovi uuesti',
    errorServer: (status: number) => `Serveri viga (${status}). Tulemusi ei õnnestunud laadida.`,
    errorNetwork: 'Tulemusi ei õnnestunud laadida. Kontrolli ühendust.',
    overall: 'Üldarvestus',
    ...
    sections: { timing: 'Tulemused', broadcast: 'Otseülekanne', blog: 'Otseblogi' },
    chooseSection: 'Vali osa',
    broadcast: {
      title: 'Otseülekanne',
      source: 'YouTube',
      play: 'Vaata otseülekannet',
      loadNote: 'Video laetakse klõpsuga (YouTube’i sisu ja küpsised).',
      openOnYouTube: 'Ava YouTube’is',
      empty: 'Otseülekannet praegu ei ole.',
      emptyHint: 'Kui korraldaja ülekande avab, ilmub see siia. Seni: tulemused ja otseblogi.',
    },
    blog: {
      title: 'Otseblogi',
      source: 'autoralli.ee kaasautorid',
      postCount: (n: number) => `${n} postitust`,
      hashtagCta: 'Oled rajal? Postita Instagrami märksõnaga',
      filterByStage: 'Katse',
      newPosts: (n: number) => (n === 1 ? '1 uus postitus' : `${n} uut postitust`),
      empty: 'Postitusi veel ei ole. Blogi täitub võistluse ajal.',
      pinned: 'Kinnitatud',
      notice: 'Korraldaja teade',
      openStage: (code: string) => `Ava ${code} tulemused`,
      playVideo: 'Mängi videot',
...
const en = {
  ...
  home: {
    ...
    // Homepage (Broadcast Grid)
    round: 'R',
    nextRound: 'Next round',
    roundStripAria: 'Next round and countdown',
    countdownDays: 'D',
    countdownHours: 'H',
    countdownMinutes: 'M',
    countdownSeconds: 'S',
    countdownDaysLong: 'days',
    countdownHoursLong: 'hrs',
    countdownMinutesLong: 'min',
    countdownSecondsLong: 'sec',
    countdownAria: 'Time until the next round starts',
    ongoing: 'Under way',
    quickLinksAria: 'Quick links',
    quickLive: 'Live',
    quickCalendar: 'Calendar',
    quickResults: 'Results',
    quickClasses: 'Classes',
    quickNewFans: 'New to rally?',
    newsUnavailable: 'The news could not be loaded right now. Fresh rally news is on autosport.ee.',
    newsHeroAria: 'Top stories',
    newsSlideOf: (n: number, total: number) => `Story ${n} of ${total}`,
    newsPause: 'Pause rotation',
    newsPlay: 'Resume rotation',
    seasonTitle: 'Season 2026',
    seasonAria: 'Season calendar',
    seasonAll: 'Full calendar',
    seasonDone: 'Completed',
    seasonNext: 'Next',
    standingsTitle: 'Standings',
    standingsClass: 'EMV overall',
    standingsSample: 'Sample data',
    standingsSampleNote: 'Real standings will appear once the EAL data source is connected.',
    standingsFull: 'Full standings',
    standingsSource: 'Source: EAL',
    standingsUpdated: 'updated',
    standingsPending: 'pending',
    standingsPoints: 'pts',
    newsTitleGrid: 'News',
    joinTitle: 'Come to a rally',
    joinLead: 'Special stages are free to watch. See how to get to the roadside safely as a spectator.',
    joinCta: 'For spectators',
    joinCompete: 'For competitors',
  },
  calendar: {
    eyebrow: 'Calendar',
  ...
  results: {
    ...
    poweredBy: 'Powered by',
    poweredByAria: 'RallyLynx — timing and results platform (opens in a new window)',
    position: 'Pos',
  ...
  live: {
    ...
    classView: (name: string) => `${name} classification`,
    classPositionsNote: 'Position and gap are computed within the selected class from the RallyLynx overall times.',
    stage: 'Stage',
    chooseStage: 'Choose a stage',
    latest: 'Latest',
    after: (stage: string) => `after ${stage}`,
    overallAfter: (stage: string) => `Overall — after ${stage}`,
    eventBarAria: 'Event and status',
    finished: 'Finished',
    scheduled: 'Not started',
    crewCount: (n: number) => `${n} crews`,
    connectionLost: 'Connection lost.',
    showingStateFrom: 'Showing the state from',
    retry: 'Try again',
    errorServer: (status: number) => `Server error (${status}). The results could not be loaded.`,
    errorNetwork: 'The results could not be loaded. Check your connection.',
    overall: 'Overall',
    ...
    sections: { timing: 'Results', broadcast: 'Live broadcast', blog: 'Live blog' },
    chooseSection: 'Choose a section',
    broadcast: {
      title: 'Live broadcast',
      source: 'YouTube',
      play: 'Watch the broadcast',
      loadNote: 'The video loads on tap (YouTube content and cookies).',
      openOnYouTube: 'Open on YouTube',
      empty: 'There is no live broadcast right now.',
      emptyHint: 'It appears here when the organiser opens one. Until then: results and the live blog.',
    },
    blog: {
      title: 'Live blog',
      source: 'autoralli.ee contributors',
      postCount: (n: number) => `${n} posts`,
      hashtagCta: 'At a stage? Post to Instagram with',
      filterByStage: 'Stage',
      newPosts: (n: number) => (n === 1 ? '1 new post' : `${n} new posts`),
      empty: 'No posts yet. The blog fills up during the rally.',
      pinned: 'Pinned',
      notice: 'Organiser notice',
      openStage: (code: string) => `Open ${code} results`,
